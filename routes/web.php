...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'deposit', 'as' => 'deposit.'], function () {
        ...
        Route::get('/bank', [DepositController::class, 'bank'])->name('bank');
    });
    ...
    Route::group(['prefix' => 'order', 'as' => 'order.'], function () {
        ...
        Route::post('/sync/{id}', [OrderController::class, 'sync'])->name('sync');
    });
    ...
    Route::group(['prefix' => 'api', 'as' => 'api.docs.'], function () {
        Route::get('/docs', [\App\Http\Controllers\ApiDocsController::class, 'index'])->name('index');
        Route::post('/generate', [\App\Http\Controllers\ApiDocsController::class, 'generateToken'])->name('generate');
    });
});
