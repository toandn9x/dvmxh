                        ...
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td>
                                        <div>{{ number_format($order->total) }}đ</div>
                                        <small class="text-muted">API ID: {{ $order->api_order_id ?: 'N/A' }}</small>
                                    </td>
                                    <td>
                                        <div class="text-truncate" style="max-width: 150px;">{{ $order->input }}</div>
                                        @if($order->note) <small class="text-muted d-block">{{ $order->note }}</small> @endif
                                    </td>
                                    <td>
