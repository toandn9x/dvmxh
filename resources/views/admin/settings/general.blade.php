            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="zalo_link">Link Zalo (Hỗ trợ)</label>
                            <input type="text" class="form-control" id="zalo_link" name="zalo_link" value="{{ setting('zalo_link') }}" placeholder="https://zalo.me/...">
                        </div>
                        <div class="mb-3">
                            <label for="messenger_link">Link Messenger (Hỗ trợ)</label>
                            <input type="text" class="form-control" id="messenger_link" name="messenger_link" value="{{ setting('messenger_link') }}" placeholder="https://m.me/...">
                        </div>
