                    ...
                    <form action="{{ route('admin.packages.store') }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="provider" name="provider" class="form-control" placeholder="Ví dụ: trumsub" value="{{ old('provider') }}" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="api_service_id" class="form-label">API Service ID</label>
                                <input type="text" id="api_service_id" name="api_service_id" class="form-control" placeholder="ID dịch vụ bên phía API" value="{{ old('api_service_id') }}" />
                            </div>
                        </div>
