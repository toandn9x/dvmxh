        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex align-items-center">
                    <div class="px-3 py-1 bg-soft-success rounded-pill d-flex align-items-center me-2">
                        <i class="bx bx-wallet text-success fs-18 me-1"></i>
                        <span class="fw-bold text-success">{{ number_format(Auth::user()->balance) }}đ</span>
                    </div>
                    <a href="{{ route('deposit.bank') }}" class="btn btn-sm btn-primary rounded-pill px-3 me-2">
                        <i class="ri-add-line align-bottom me-1"></i> Nạp tiền
                    </a>
                </div>
