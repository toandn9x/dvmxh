                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-inline hstack gap-2 mb-0">
                                            <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Cập nhật">
                                                <form action="{{ route('order.sync', $order->id) }}" method="POST" class="d-inline">
                                                    @csrf
